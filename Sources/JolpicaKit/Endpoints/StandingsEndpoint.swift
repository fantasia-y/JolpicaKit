...
public class DriverStandingsEndpoint: JolpicaEndpoint, @unchecked Sendable {
    ...
    public func getDriverStandings(season: String, round: String? = nil) async -> Result<MRData<StandingsTable<DriverStanding>>> {
        return await execute(JolpicaRequest(
    ...
    public func getDriverStandings(season: String, round: String? = nil, driverId: String) async -> Result<MRData<StandingsTable<DriverStanding>>> {
        return await execute(JolpicaRequest(
            endpoint: .drivers,
            season: season,
            round: round,
    ...
    public func getDriverStandings(season: String, round: String? = nil, finishPosition: String) async -> Result<MRData<StandingsTable<DriverStanding>>> {
        return await execute(JolpicaRequest(
            endpoint: .driverstandings,
            season: season,
            round: round,
